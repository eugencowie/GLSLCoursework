...
Game::Game() :
	...
	m_lampTransform1({4.5f, 0, -4.25f}, {1,2,1}, {{90}}),
	m_lampTransform2({-1.5f, 0, -4.25f}, {1,2,1}, {{90}}),
	m_lampTransform3({-7.5f, 0, -4.25f}, {1,2,1}, {{90}}),
	m_lampTransform4({-13.f, 0, -4.25f}, {1,2,1}, {{90}}),
	...
	m_pointLight1({4.5f, 5.75f, -4.2f}, 0.7f, 1.8f, 1, vec3(0), {1, 1, 0.5f}),
	m_pointLight2({-1.5f, 5.75f, -4.2f}, 0.7f, 1.8f, 1, vec3(0), {1, 1, 0.5f}),
	m_pointLight3({-7.5f, 5.75f, -4.2f}, 0.7f, 1.8f, 1, vec3(0), {1, 1, 0.5f}),
	m_pointLight4({-13.f, 5.75f, -4.2f}, 0.7f, 1.8f, 1, vec3(0), {1, 1, 0.5f}),
	m_spotLight1({4.5f, 5.75f, -4.2f}, {-0, -1, 0}, cos(radians(27.5f)), cos(radians(35.f)), 0.045f, 0.0075f, 1, vec3(0), {1, 1, 0.5f}),
	m_spotLight2({-1.5f, 5.75f, -4.2f}, {-0, -1, 0}, cos(radians(27.5f)), cos(radians(35.f)), 0.045f, 0.0075f, 1, vec3(0), {1, 1, 0.5f}),
	m_spotLight3({-7.5f, 5.75f, -4.2f}, {-0, -1, 0}, cos(radians(27.5f)), cos(radians(35.f)), 0.045f, 0.0075f, 1, vec3(0), {1, 1, 0.5f}),
	m_spotLight4({-13.f, 5.75f, -4.2f}, {-0, -1, 0}, cos(radians(27.5f)), cos(radians(35.f)), 0.045f, 0.0075f, 1, vec3(0), {1, 1, 0.5f})
{
...
void Game::render()
{
	...
	vector<PointLight> pointLights = { m_pointLight1, m_pointLight2, m_pointLight3, m_pointLight4 };
	vector<SpotLight> spotLights = { m_spotLight1, m_spotLight2, m_spotLight3, m_spotLight4 };
	...
	m_lampModel.draw(m_lampTransform4.model(), m_camera.view(), m_viewport.projection(), directionalLights, pointLights, spotLights);
